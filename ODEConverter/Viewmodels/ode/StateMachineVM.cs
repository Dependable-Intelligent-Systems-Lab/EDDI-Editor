...
namespace ODEConverter.Viewmodels.ode
{
	...
	public class StateMachineVM
	{
		...
		public StateMachineVM(ODELib.ode.StateMachine sm)
		{
			OdeStateMachine = sm;
		...
		private ODELib.ode.StateMachine OdeStateMachine { get; set; }
		...
		[DisplayName("Name")]
		[Description("Name")]
		public string Name { get => OdeStateMachine.Name; set => OdeStateMachine.Name = value; }
